...
var transporter = nodemailer.createTransport({
  service: "gmail",
  auth: {
    user: "sparkit.sparkom@gmail.com",
    pass: "Sparkom2021",
  },
});
...
var mailOptions = {
  ...
  subject: "Sparkom Verification Code",
};

const sendEmail = (verifCode, email) => {
  ...
  <body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
   ...
   organize, share and use all your visual assets in one place - all on your desktop." height="32" src="https://res.cloudinary.com/sparkom/image/upload/v1619741116/logosparkom_gon6ei.png" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
   ...
   color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
   line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
   padding-bottom: 9px; padding-left: 18px;' valign="top"> Your Verification Code :
                                  <br></br>
                                </td>
                              </tr>
                            </tbody>
